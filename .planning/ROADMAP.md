...
- UI-01: web UI showing cluster assignments, soft probs, conversation history, per-turn metrics
- UI-02: dataset upload via web UI

**Trio requirements added:**
...
| 2. Clustering Agent Core | ⬜ Not started | 1–2 |
...
*Headline questions: Q1 (convergence speed) + Q6 (LLM vs human oracles)*
*Tier: Trio*
