...
```
  ...
  <acceptance_criteria>
    ...
    - pytest tests/test_judge.py::test_all_three_stopping_conditions exits 0 (or equivalent individual tests)
  </acceptance_criteria>
</task>
...
- All three stopping conditions independently triggered in tests
